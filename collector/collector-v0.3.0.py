#!/usr/bin/python
# -*- coding: utf-8 -*-
# version: 0.3.0 (veritabanına yazdırma)
...
with sqlite.connect('/home/omfaer/desktop/SQLite/SDataS.db') as db:
  cursor=db.cursor()
...
#    cursor.execute("""INSERT INTO ApkInfo VALUES(6431,'Test','com.test.deneme.birki','https://www.sdatam.com/','1','1')""")
    db.commit()
